      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 p-4 rounded-full bg-gradient-to-r from-purple-600 to-cyan-500 text-white shadow-[0_0_15px_rgba(168,85,247,0.4)] transition-shadow border border-white/20"
          >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 z-50 w-[90vw] md:w-[400px] h-[550px] max-h-[80vh] flex flex-col bg-slate-950/80 backdrop-blur-xl border border-purple-500/30 rounded-2xl shadow-[0_0_40px_rgba(168,85,247,0.15)] overflow-hidden"
          >
            {/* Header */}
            <div className="flex items-center justify-between p-4 bg-slate-900/50 border-b border-purple-500/20 backdrop-blur-md">
            ...
            {/* Input Area */}
            <div className="p-3 bg-slate-900/80 border-t border-purple-500/20 backdrop-blur-md">
              <form
